    ...
    return (
        ...
        <>
            ...
            <section className="mx-auto max-w-[80rem] flex flex-col items-center ">
                ...
                <section className="w-full flex flex-col mt-40 gap-10">
                <h1 className="leading-[50px] text-[50px] font-bold text-[#1d4865]">Check talents</h1>

                    <div className="grid grid-cols-4 grid-rows-2 w-full gap-10">
            ...
            <footer className="grid grid-cols-3 gap-x-20 py-20 bg-[#1d4865] px-40 text-white/80">
                <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-5 items-center">
                    <h1 className="font-bold text-[20px] text-white mb-5">Quick Links</h1>
                ...
                <div>
                    <h1 className="font-bold text-[20px] text-white mb-5"> Contact us</h1>
